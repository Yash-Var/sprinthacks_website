...
const Sponsors = () => {
  const speaker = [
    {
      name: "Saumya Singh",
      image: "https://media.licdn.com/dms/image/D4D03AQH4bZDQNQJC9Q/profile-displayphoto-shrink_800_800/0/1671964649007?e=1685577600&v=beta&t=mSkDtZjpHiLVfERSi27O2h6AmVgp0cYXecOJpNom4ec",
      Work: "SDE @RedHat",
      Description: "",
      socials: {
    ...
    },
    {
      ...
      image: "https://media.licdn.com/dms/image/C4D03AQHYTCI3PC-YnQ/profile-displayphoto-shrink_800_800/0/1650352735413?e=1685577600&v=beta&t=NNJlE6FMxGSTnFN23WLgv7EQw4USZZDCkb3WHbK3LQg",
      Work: "SWE III @Google ",
      Description: "",
      socials: {
    ...
    {
      name: "Rohit Negi",
      image: "https://media.licdn.com/dms/image/C5603AQER4rVidEPXUg/profile-displayphoto-shrink_800_800/0/1647701218350?e=1685577600&v=beta&t=95GHLqHErA5mNJxMZ2syxXUQvWHLWUkUU7mcHx8mqrs",
      Work: "SDE @UBER ",
      Description: "",
      socials: {
  ...
  return (
    <div className="bg-newcolor" id="sponsor">
      <div className="flex justify-center pt-16 pb-10  max-[415px]:ml-5 ">
        <center><h1 className="text-white text-7xl main max-[500px]:text-6xl max-[415px]:text-5xl max-[466px]:mr-5">
          SPEAKER & JUDGES
        </h1></center>
      </div>
      <div className="Speaker_big_box w-[80%] m-auto flex flex-wrap justify-center">
        {speaker.map((data)=>{
          return (
           ...
           <center><img className="speaker_image rounded-full mb-2 border-4 flex border-white" src={data.image}/></center>
