    ...
    import Health from '../images/s.png'
    function Cards2() {
    return (
            ...
            <div>
                <img src={Health} className='h-[400px] ml-24 mt-20 w-[1750px]'></img>
            </div>
            <div className='ml-72 mt-24'>
            <h1 className='text-white main text-6xl semibold mr-40'>Healthcare</h1>
