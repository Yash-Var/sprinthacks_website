  ...
  return (
    <div className='bg-newcolor'>
      ...
      <div className='flex pt-16 pb-10 justify-around'>
        <img src={Line} className="h-2 mt-7 mx-10 overflow-hidden max-md:mx-3" />
        <h1 className='text-white text-6xl main'>GOLD</h1>
        <img src={Line} className="h-2 mt-7 mx-10 overflow-hidden max-md:mx-3" />
      </div>
      <div className=' flex  flex-wrap justify-center pt-10 pb-10 '>
        <button type="button" className="bg-[#273339] rounded-lg  px-20 py-5 mr-3 my-5">
        ...
        <button type="button" className="bg-[#273339] rounded-lg  py-5 px-24 mr-2 my-5">
          <div className='flex space-x-2'>
            <div>
              <img src={Polygon} />
            </div>
      ...
      <div className='flex  flex-wrap justify-center pt-10 pb-10 '>
        <button type="button" className="bg-[#273339] rounded-lg  px-5 py-4 mr-3 my-5">
        ...
        <button type="button" className="bg-[#273339] rounded-lg  px-28 py-6 ml-3 mr-6 my-5">
          <div className='flex space-x-1'>
            <div>
              <img src={Replit1} />
            </div>
        ...
        <button type="button" className="bg-[#273339]  rounded-lg  px-24 py-5 mr-2 my-5">
          <div className='flex space-x-2'>
            <div>
              <img src={filecoin} />
            </div>
