...
const Sponsors = () => {
  return (
    <div className='bg-newcolor'>
      ...
      <button type="button" className="bg-[#273339] rounded-lg  px-20 py-5 mr-5">
      ...
      <button type="button" className="bg-[#273339] rounded-lg  px-20 py-5 ml-5">
        <div className='flex space-x-2'>
          <div>
        <img  src={Polygon}/>
          </div>
     ...
     <h1 className='text-white text-6xl main'>SILVER</h1>
      ...
      <div className='flex justify-center pt-10 pb-10 '>
      <button type="button" className="bg-[#273339] rounded-lg  px-5 py-5 mr-5">
      ...
      <button type="button" className="bg-[#273339] rounded-lg  px-24 py-5 ml-5 mr-5">
        <div className='flex space-x-1'>
          <div>
        <img  src={Replit1}/>
          </div>
      ...
      <button type="button" className="bg-[#273339] rounded-lg  px-24 py-5 ml-5">
        <div className='flex space-x-2'>
          <div>
        <img  src={filecoin}/>
          </div>
