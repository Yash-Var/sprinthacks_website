            ...
            <div className="swip-slide">
              ...
              <div className="slide-content">
                ...
                <div className="abouttext text-white text-2xl semibold pt-8 ">
                  ...
                  to build and showcase their solutions that harness the power
                  of decentralized systems to improve privacy, security, and
                  ownership of data.
                </div>
              </div>
            </div>
          ...
          <SwiperSlide>
            ...
            <div className="swip-slide">
              ...
              <div className="slide-content">
                ...
                <div className="abouttext text-white text-2xl semibold pt-8 ">
                  The Open Innovation theme of this hackathon invites
                  participants to explore new ways of problem-solving and
                  collaboration. This theme encourages individuals to work
                  together, share ideas, and bring innovative solutions to life.
                  Participants will have the opportunity to develop their
                  solutions with the support of a diverse community, utilizing a
